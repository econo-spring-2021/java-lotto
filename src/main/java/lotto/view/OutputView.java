...
public class OutputView {
    ...
    private static final String FIFTH_LOTTO_MESSAGE = "3개 일치 (" + LottoTicket.FIFTH_LOTTO_PRICE + "O원)- ";
    private static final String FORTH_LOTTO_MESSAGE = "4개 일치 (" + LottoTicket.FORTH_LOTTO_PRICE + ")- ";
    private static final String THIRD_LOTTO_MESSAGE = "5개 일치 (" + LottoTicket.THIRD_LOTTO_PRICE + ")- ";
